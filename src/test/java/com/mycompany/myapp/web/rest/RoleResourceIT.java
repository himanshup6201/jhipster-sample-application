...
import com.mycompany.myapp.repository.search.RoleSearchRepository;
...
public class RoleResourceIT {
     ...
     *
     * @see com.mycompany.myapp.repository.search.RoleSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final RoleResource roleResource = new RoleResource(roleRepository, mockRoleSearchRepository);
